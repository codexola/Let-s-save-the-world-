...
const messages: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    "global.currency": "通貨",
    "global.timezone": "タイムゾーン",
    "global.compliance": "地域コンプライアンス",
    "api.portal": "開発者ポータル",
    "exec.dashboard": "経営ダッシュボード",
  },
  en: {
    ...
    "lang.label": "Language",
    "global.title": "Global platform",
    "global.currency": "Currency",
    "global.timezone": "Time zone",
    "global.compliance": "Regional compliance",
  ...
  ko: {
    ...
    "lang.label": "언어",
    "global.title": "글로벌 플랫폼",
    "global.currency": "통화",
    "global.timezone": "시간대",
    "global.compliance": "지역 컴플라이언스",
    "api.portal": "개발자 포털",
    "exec.dashboard": "경영 대시보드",
  },
  zh: {
    ...
    "global.currency": "货币",
    "global.timezone": "时区",
    "global.compliance": "区域合规",
    "api.portal": "开发者门户",
    "exec.dashboard": "高管仪表盘",
  },
};
